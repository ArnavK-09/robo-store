...
export default {
	...
	domain: '3000-arnavk09-rbj-qabecqnk2v3.ws-us116.gitpod.io',
	introduction: `Welcome to WristWatchers, where timekeeping transcends mere functionality and transforms into a sophisticated expression of style. Since our founding in 2024, we have dedicated ourselves to crafting exceptional timepieces that combine meticulous craftsmanship with innovative design. Our passion for horology drives us to create watches that not only tell time but also tell your story, elevating everyday moments into extraordinary experiences. Explore our diverse collection, where classic elegance meets modern flair, and discover the perfect watch to accompany you on life's journey.`,
